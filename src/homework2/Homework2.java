...
public class Homework2 {
    ...
    public static void ex1() {
        ...
        System.out.println(wordsString.substring(0, wordsString.length() -1));
    }
    ...
    public static void ex2() {
        ...
        for (int[] array : arrayOfNumbers) {
            for (int number : array) {
                for (int i = 0; i < array.length; i++) {
                    leftUpToRightDownSum = leftUpToRightDownSum + array[i];

                }
            }
        }
        System.out.println("Сумма чисел по диагонали с левого верхнего угла к нижнему правому: "
                + leftUpToRightDownSum);
        System.out.println("Сумма чисел по диагонали с левого нижнего угла к верхнему правому: "
